        ...
        <div class="col-sm-8 col-md-8 col-lg-8">          
         ...
         <div class="col-sm-1 col-md-1 col-lg-1">
          ...
          <div class="col-sm-2 col-md-2 col-lg-2">
            ...
            <button type="button" class="btn btn-info btn-sm headerbtn disabled"><span class="glyphicon glyphicon-plus"></span> Sign Up</button>

            <button type="button" class="btn btn-info btn-sm headerbtn"><span class="glyphicon glyphicon-user"></span> Log In</button>
             ...
             <form class="form-horizontal" role="form" id="signUp" action="feed.php" method="get">
                ...
                <div class="form-group form-group-sm">
                  ...
                  <div class="col-sm-6">
                    ...
                    <span class="help-block"><small>at least 8 characters long</small></span>
                  </div>
                </div>
                 <div class="form-group form-group-sm">
                  <label class="col-sm-2 control-label" for="retype_pw">retype password</label>
                  <div class="col-sm-6">
                    <input class="form-control" type="password" id="retype_pw" name="retype_pw"> 
                  </div>
                </div>
